...
<div class="container" style="width: 800px">
    <div class="flex" style="display: flex; width: 800px">
        <? if (isset($teacher)) { ?>
            ...
            <div class="update" style="width: 620px; border: #31708f 1px solid;margin: 40px 0 10px 20px">

                <form style="width: 250px;margin: 0 20px;"
                      action="<?= base_url('/director/updateTeacher/' . $teacher['id']) ?>" method="post">
        ...
        <? } ?>
        <div class="add" style="width: 620px; border: #31708f 1px solid;margin: 40px 0 10px 20px">
            <form style="width: 250px;margin: 0 20px;" action="<?= base_url('/director/createTeacher') ?>"
                  method="post">
                <div class="content is-normal" style="margin: 10px 0 10px 20px">
                    <h3>Add teacher:</h3>
                </div>
                ...
                <? foreach ($teachers as $teacher) { ?>
                    ...
                    <tr>
                        ...
                        <td><a class="button is-small"
                               href="<?= base_url('/director/teachers/' . $teacher['id']) ?>">Edit</a>
                        </td>
                        <td><a class="button is-small"
                               href="<?= base_url('/director/deleteTeacher/' . $teacher['id']) ?>">Delete</a></td>
                    </tr>
                <? } ?>
